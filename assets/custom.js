...
document.addEventListener('DOMContentLoaded', function() {
  var buttons = document.querySelectorAll('a.btn.btn--large.btn--wide');
  var shippingMessage = document.querySelector('.shipping-free-message');
  console.log("Element Selected", shippingMessage ,".";

  
  if (shippingMessage) {
    buttons.forEach(function(button) {
      console.log("Element Moved");
      button.parentNode.insertBefore(shippingMessage, button);
    });
  }
});
